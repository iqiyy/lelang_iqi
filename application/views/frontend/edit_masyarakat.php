            ...
            <div class="card-body">
                <form action="" method="POST" autocomplete="off">
                    <div class="form-group">
                        ...
                        <input type="email" readonly value="<?= $masyarakat->email ?>" class="form-control" name="email"
                    ...
                    <div class="form-group">
                        ...
                        <select name="jk" id="jk" class="form-control" required>
                            <option value="Laki-laki" <?= ($masyarakat->jk == "Laki-laki") ? 'selected' : '' ?>>
                                Laki-laki</option>
                            <option value="Perempuan" <?= ($masyarakat->jk == "Perempuan") ? 'selected' : '' ?>>
                                Perempuan</option>
                        </select>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <textarea class="form-control" name="alamat" required
                            maxlength="250"><?= $masyarakat->alamat ?></textarea>
                    </div>
                    <div class="float-right">
                        <button type="submit" id="save" value="save" class="btn btn-warning"><i
                                class="fa-regular fa-floppy-disk"></i> Update Data</button>
                    </div>
                </form>
            </div>
        </div>
