                ...
                <table id="pemenang" class="table table-striped table-bordered table-hover small">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="#"
                                    data-confirm-url="<?= site_url('backend/lelang/confirm/' . $p->id_lelang) ?>"
                                    onclick="dataConfirm(this)"><button type="button" class="btn btn-success"
                                        title="Confirm"><i class="fa-solid fa-circle-check"></i></button></a>
                            </td>
                            <?php endif ?>
                        </tr>
                        <?php endforeach ?>
