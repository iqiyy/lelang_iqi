    ...
    <main class="main">
        ...
        <div class="content">
            <div class="container my-4">
                ...
                <a href="<?= site_url('backend/users/new') ?>" class="btn btn-success justify-content-end mt-2"
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a href="<?= site_url('backend/users/update/' . $u->id_user) ?>">
                                    ...
                                    <a href="#" data-confirm-url="<?= site_url('backend/users/block/' . $u->id_user) ?>"
                                        onclick="dataConfirm(this)"><button type="button" class="btn btn-danger"
                                            title="Block"><i class=" fa-solid fa-user-xmark"></i></button></a>
                                    <?php endif ?>
                                </td>
                            </tr>
                            <?php endforeach ?>
