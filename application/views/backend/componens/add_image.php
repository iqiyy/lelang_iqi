                            ...
                            <form action="" method="POST" enctype="multipart/form-data">
                                <div class="form-group">
                                    ...
                                    <input type="text" value="<?= $barang->nama_barang ?>" class="form-control"
                                        name="nama_barang" readonly required maxlength="200" />
                                ...
                                <div class="float-right">
                                    ...
                                    <?php if ($barang->status <> "Sold") : ?>
                                    <button type="submit" id="save" value="save" class="btn btn-success"><i
                                            class="fa-regular fa-floppy-disk"></i> Upload</button>
                                    <?php endif ?>
                                </div>
                            </form>
                        </div>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <!-- Delete -->
                                        <a href="#"
                                            data-delete-url="<?= site_url('backend/barang/deleteImage/' . $b->id_gambar) ?>"
