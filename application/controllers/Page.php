...
class Page extends CI_Controller 
{
    ...
    {
        $data['lelang'] = $this->lelang_model->get_status_open();
      ...
      public function login()
    {
        ...
        $this->load->view('backend/login_front', $data);
    }
    ...
    public function edit()
    {
        ...
        $this->load->view('frontend/edit_masyarakat', $data);
    }
    ...
    public function penawaran()
    {
        ...
        $this->load->view('frontend/riwayat_penawaran', $data);
    }
    ...
    {
        $data['activeUser'] = $this->authfront_model->current_user();
        $data['pemenang'] = $this->lelang_model->get_pemenang($data['activeUser']->id_masyarakat);
        $this->load->view('frontend/pemenang_lelang', $data);
    }
    ...
    public function detail_lelang($id_lelang = null)
    {
        ...
        $this->load->view('frontend/detail_lelang', $data);
    }
