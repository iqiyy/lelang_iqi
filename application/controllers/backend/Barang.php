...
class Barang extends CI_Controller
{
	...
	public function update($id_barang = null)
	{
		...
		$this->load->view('backend/componens/update_barang', $data);
	}
	public function detail($id_barang)
	{
		$data['barang'] = $this->barang_model->get_id($id_barang)->row();
		$data['gambar'] = $this->gambar_model->get_utama_Barang($id_barang)->row();
		if (!$data['barang'] || !$id_barang) {
			show_404();
